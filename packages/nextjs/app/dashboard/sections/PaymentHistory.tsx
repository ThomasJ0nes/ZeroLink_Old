            ...
            <TableHeader>
              <TableRow>
                <TableHead className="w-[100px]">
                  <Button variant="ghost" onClick={() => sortTransactions("date")}>
                    Date
                ...
                <TableHead>
                  <Button variant="ghost" onClick={() => sortTransactions("amount")}>
                    Amount (ETH)
                    <ArrowUpDown className="ml-2 h-4 w-4" />
                  </Button>
                </TableHead>
                ...
                <TableHead>
                  <Button variant="ghost" onClick={() => sortTransactions("status")}>
                    Status
                    <ArrowUpDown className="ml-2 h-4 w-4" />
                  </Button>
                </TableHead>
            ...
            <TableBody>
              {transactions.map(transaction => (
                <TableRow key={transaction.id}>
                  <TableCell className="font-medium">{format(transaction.date, "yyyy-MM-dd")}</TableCell>
